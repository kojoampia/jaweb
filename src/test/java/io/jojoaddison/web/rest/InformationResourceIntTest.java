...
public class InformationResourceIntTest {
     ...
     *
     * @see io.jojoaddison.repository.search.InformationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final InformationResource informationResource = new InformationResource(informationRepository, mockInformationSearchRepository);
    ...
    public void searchInformation() throws Exception {
        // Initialize the database
        informationRepository.save(information);
        when(mockInformationSearchRepository.search(queryStringQuery("id:" + information.getId())))
            .thenReturn(Collections.singletonList(information));
