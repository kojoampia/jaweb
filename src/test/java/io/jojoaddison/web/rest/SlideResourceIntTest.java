...
public class SlideResourceIntTest {
     ...
     *
     * @see io.jojoaddison.repository.search.SlideSearchRepositoryMockConfiguration
     */
    @Autowired
    private SlideSearchRepository mockSlideSearchRepository;
    ...
    public void setup() {
        ...
        final SlideResource slideResource = new SlideResource(slideRepository, mockSlideSearchRepository);
    ...
    public void createSlide() throws Exception {
        ...
        verify(mockSlideSearchRepository, times(1)).save(testSlide);
    }
    ...
    public void createSlideWithExistingId() throws Exception {
        ...
        // Validate the Slide in Elasticsearch
        verify(mockSlideSearchRepository, times(0)).save(slide);
    }
    ...
    public void deleteSlide() throws Exception {
        ...
        // Validate the Slide in Elasticsearch
        verify(mockSlideSearchRepository, times(1)).deleteById(slide.getId());
    }
    ...
    public void searchSlide() throws Exception {
        // Initialize the database
        slideRepository.save(slide);
        when(mockSlideSearchRepository.search(queryStringQuery("id:" + slide.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(slide), PageRequest.of(0, 1), 1));
        // Search the slide
