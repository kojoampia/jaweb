...
import { ContactMessageComponent } from 'app/entities/contact-message/contact-message.component';
...
describe('Component Tests', () => {
    describe('ContactMessage Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.contactMessages[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
