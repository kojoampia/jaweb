...
describe('Service Tests', () => {
    describe('Imprint Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Imprint', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 'ID',
                        createdDate: currentDate.format(DATE_TIME_FORMAT),
            ...
            it('should update a Imprint', async () => {
                const returnedFromService = Object.assign(
                    {
                        title: 'BBBBBB',
                        content: 'BBBBBB',
            ...
            it('should return a list of Imprint', async () => {
                const returnedFromService = Object.assign(
                    {
                        title: 'BBBBBB',
                        content: 'BBBBBB',
            ...
            it('should delete a Imprint', async () => {
