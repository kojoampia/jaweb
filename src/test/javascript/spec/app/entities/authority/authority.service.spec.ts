...
import { IAuthority, Authority } from 'app/shared/model/authority.model';
...
describe('Service Tests', () => {
    describe('Authority Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Authority('ID', 'AAAAAAA');
        });
