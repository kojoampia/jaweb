...
import { sampleWithRequiredData } from '../staff.test-samples';
...
describe('Staff Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, StaffComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.staff?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
