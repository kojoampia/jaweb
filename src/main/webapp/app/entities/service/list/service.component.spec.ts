...
import { sampleWithRequiredData } from '../service.test-samples';
...
describe('Service Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ServiceComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.services?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
