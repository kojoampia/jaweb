...
export class ServiceComponent implements OnInit {
  ...
  trackId = (_index: number, item: IService): string => this.serviceService.getServiceIdentifier(item);
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.serviceService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
