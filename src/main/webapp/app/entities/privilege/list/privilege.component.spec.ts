...
import { sampleWithRequiredData } from '../privilege.test-samples';
...
describe('Privilege Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PrivilegeComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.privileges?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
