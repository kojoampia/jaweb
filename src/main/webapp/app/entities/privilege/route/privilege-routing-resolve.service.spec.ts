...
import privilegeResolve from './privilege-routing-resolve.service';
  ...
  describe('resolve', () => {
    it('should return IPrivilege returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        privilegeResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
      ...
      expect(resultPrivilege).toEqual({ id: 'ABC' });
    });
