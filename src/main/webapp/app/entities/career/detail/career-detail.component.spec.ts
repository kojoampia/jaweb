...
describe('Career Management Detail Component', () => {
  ...
  describe('OnInit', () => {
    it('Should load career on init', async () => {
      const harness = await RouterTestingHarness.create();
      const instance = await harness.navigateByUrl('/', CareerDetailComponent);

      // THEN
      expect(instance.career()).toEqual(expect.objectContaining({ id: 'ABC' }));
    });
  });
