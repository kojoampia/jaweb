...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../about.test-samples';

import { AboutService, RestAbout } from './about.service';

const requireRestSample: RestAbout = {
...
describe('About Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a About', () => {
      const about = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(about).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a About', () => {
      const about = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(about).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addAboutToCollectionIfMissing', () => {
      it('should add a About to an empty array', () => {
        const about: IAbout = sampleWithRequiredData;
      ...
      it("should add a About to an array that doesn't contain it", () => {
        const about: IAbout = sampleWithRequiredData;
        const aboutCollection: IAbout[] = [sampleWithPartialData];
        expectedResult = service.addAboutToCollectionIfMissing(aboutCollection, about);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(about);
      });
      ...
      it('should add only unique About to an array', () => {
        const aboutArray: IAbout[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const aboutCollection: IAbout[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const about: IAbout = sampleWithRequiredData;
        const about2: IAbout = sampleWithPartialData;
    ...
    describe('compareAbout', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareAbout(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareAbout(entity1, entity2);
        const compareResult2 = service.compareAbout(entity2, entity1);
