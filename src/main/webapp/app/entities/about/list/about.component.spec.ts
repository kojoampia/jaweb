...
import { sampleWithRequiredData } from '../about.test-samples';
...
describe('About Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, AboutComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to aboutService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getAboutIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAboutIdentifier).toHaveBeenCalledWith(entity);
