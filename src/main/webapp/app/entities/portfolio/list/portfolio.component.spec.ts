...
import { sampleWithRequiredData } from '../portfolio.test-samples';
...
describe('Portfolio Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PortfolioComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.portfolios?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
