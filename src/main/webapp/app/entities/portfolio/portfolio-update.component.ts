...
export class PortfolioUpdateComponent implements OnInit {
    ...
    save() {
        this.isSaving = true;
        this.portfolio.createdDate = this.createdDate != null ? dayjs(this.createdDate, DATE_TIME_FORMAT) : null;
        this.portfolio.modifiedDate = this.modifiedDate != null ? dayjs(this.modifiedDate, DATE_TIME_FORMAT) : null;
