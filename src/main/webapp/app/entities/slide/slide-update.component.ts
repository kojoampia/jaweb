...
export class SlideUpdateComponent implements OnInit {
    ...
    save() {
        this.isSaving = true;
        this.slide.createdDate = this.createdDate != null ? dayjs(this.createdDate, DATE_TIME_FORMAT) : undefined;
        this.slide.modifiedDate = this.modifiedDate != null ? dayjs(this.modifiedDate, DATE_TIME_FORMAT) : undefined;
