...
describe('Slide Management Detail Component', () => {
  ...
  describe('OnInit', () => {
    it('Should load slide on init', async () => {
      const harness = await RouterTestingHarness.create();
      const instance = await harness.navigateByUrl('/', SlideDetailComponent);

      // THEN
      expect(instance.slide()).toEqual(expect.objectContaining({ id: 'ABC' }));
    });
  });
