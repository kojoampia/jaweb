...
import { sampleWithRequiredData } from '../slide.test-samples';
...
describe('Slide Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, SlideComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.slides?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
